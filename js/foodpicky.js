...
$(document).ready(function() {
    ...
    $("#slider-range").slider({
        ...
        slide: function(event, ui) {
            //$( "#amount" ).val( "ksh" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
            $(".minvalue").html("ksh" + ui.values[0]);
            $(".maxvalue").html("ksh" + ui.values[1]);
        }
    });
    $("#amount").val("ksh" + $("#slider-range").slider("values", 0) + " - $" + $("#slider-range").slider("values", 1));

...
if (isset($_SESSION["user_id"])) {
    ...
    $recommender = new DishRecommender($db);
    $recommended_dishes = $recommender->getRecommendations($user_id);
}
?>
        ...
        <?php if (isset($recommended_dishes) && !empty($recommended_dishes)): ?>
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    ...
                    <p class="lead">Personalized dishes based on your preferences and order history</p>
                </div>
                <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                <div class="figure-wrap bg-image"
                                    data-image-src="admin/Res_img/dishes/<?php echo $dish['img']; ?>"></div>
                                <div class="content">
                                    <h5><a
                                            href="dishes.php?res_id=<?php echo $dish['rs_id']; ?>"><?php echo $dish['title']; ?></a>
                                    </h5>
